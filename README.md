...
# or
yarn installUse --legacy-peer-deps flag if you face peer-dependency errors during installation.
...
Upgraded to Next.js 16.x for CVE-2025-29927 concerns
...
Refer to the Tailwind CSS v4 Migration Guide if needed.
